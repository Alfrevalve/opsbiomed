...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'Almacen' => ['dashboard.view', 'cases.view', 'cases.close', 'schedule.view', 'trace.view', 'trace.scan', 'trace.print', 'inventory.view', 'inventory.update', 'inventory.adjust', 'catalog.import', 'reservations.create', 'returns.view', 'returns.inspect', 'failures.view', 'failures.create', 'compliance.view', 'alerts.view', 'alerts.manage', 'documents.view', 'documents.upload', 'reports.view', 'reports.inventory', 'reports.export'],
